...
# define SOUND_THRESHOLD_1              50
# define SOUND_THRESHOLD_2              75
...
# define BATTERY_LEVEL_100_MIC3_AVG     (-55 * 128)
# define BATTERY_LEVEL_75_MIC3_AVG     (-65 * 128)
# define BATTERY_LEVEL_50_MIC3_AVG     (-75 * 128)
# define BATTERY_LEVEL_25_MIC3_AVG     (-90 * 128)
